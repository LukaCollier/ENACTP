...
class RadarView(QWidget):
    ...
    def create_toolbar(self):
        ...
        toolbar.addStretch() #espace vide entre les deux boutons + et << si plusieur addstretch alors ils vont se partager l'espace
        ...
        toolbar.addWidget(lblspeed)
        slide=QSlider(Qt.Horizontal)
        slide.setMinimum(-5)
        slide.setMaximum(5)
        slide.setFixedWidth(60)
        toolbar.addWidget(slide)
        lblvalue=QLabel()
        lblvalue.setText("0")
        toolbar.addWidget(lblvalue)
        def updspeed(val):
