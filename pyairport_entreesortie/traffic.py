...
class Flight:
    ...
    def conflicts(self, other, t):
        ...
        """
        return self.distance(other, t) < SEP
...
def from_file(apt, filename):
    ...
    with open(filename) as file:
        ...
        print(count_flights_type(flights, Movement.DEP), 'departures -',
              count_flights_type(flights, Movement.ARR), 'arrivals')
        return flights


def count_flights_type(flights, t):
    return len([None for f in flights if f.type is t])
