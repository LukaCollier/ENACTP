...
class Airport:
    ...
    Attributes:
        ...
        pt_dict:  ((str, airport.AirportPoint) dict)  A dictionary from names to points
        qfu_dict:  ((str, airport.Runway) dict)  A dictionary from QFUs to runways

    """

    def __init__(self, name, points, taxiways, runways,terminals):
        """The class initializer.
...
def from_file(filename,terminals=None):
    ...
    #print( 1 if terminals !=None else 0)
    with open(filename) as file:
        airport_name = file.readline().strip()
        ...
        for line in file:
            ...
            try:
                ...
                print(error, line)   
        return Airport(airport_name, tuple(points), tuple(taxiways), tuple(runways),terminals)
