...
class RadarView(QWidget):
    ...
    #### TP2.4 Custom signals for FlightInspector
    # Custom signal to notify that a flight has been selected
    flight_selected = pyqtSignal(traffic.Flight)
    ...
    def create_toolbar(self):
        ...
        # Add slider and labels to toolbar, in the correct order
        toolbar.addStretch()
